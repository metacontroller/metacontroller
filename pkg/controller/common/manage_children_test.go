...
func TestManageChildren(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if err := ManageChildren(tt.args.dynClient(), tt.args.updateStrategy, tt.args.parent, tt.args.observedChildren, tt.args.desiredChildren, &ServerSideApplyOptions{Enabled: false}); (err != nil) != tt.wantErr {
