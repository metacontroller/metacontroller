...
// TODO: Add support for reporting events back from hooks (v2 API enhancement)
...
func (r *requestBuilder) toUniformObjectMap(objMap api.ObjectMap, fieldName string) v2.UniformObjectMap {
	...
	if r.parent == nil {
		...
		logging.Logger.V(1).Info("Composite v2 requestBuilder: parent context is nil when converting field to UniformObjectMap; returning empty map", "field", fieldName)
