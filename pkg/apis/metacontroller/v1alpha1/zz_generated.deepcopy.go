...
func (in *CompositeControllerSpec) DeepCopyInto(out *CompositeControllerSpec) {
	*out = *in
	...
	if in.Connections != nil {
		...
		*out = make([]WebhookConnection, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WebhookConnection) DeepCopyInto(out *WebhookConnection) {
	*out = *in
	if in.CABundle != nil {
		in, out := &in.CABundle, &out.CABundle
		*out = new(CABundle)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WebhookConnection.
func (in *WebhookConnection) DeepCopy() *WebhookConnection {
	if in == nil {
		return nil
	}
	out := new(WebhookConnection)
	in.DeepCopyInto(out)
	return out
}
