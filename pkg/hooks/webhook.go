...
func responseUnmarshallMode(mode *v1alpha1.ResponseUnmarshallMode, version *v1alpha1.HookVersion) v1alpha1.ResponseUnmarshallMode {
	if mode == nil {
		if version != nil && *version == v1alpha1.HookVersionV2 {
			return v1alpha1.ResponseUnmarshallModeStrict
		}
...
func (w *webhookExecutor) effectiveHookVersion() v1alpha1.HookVersion {
	if w.hookVersion != nil && *w.hookVersion != v1alpha1.HookVersion("") {
		return *w.hookVersion
	}
	return v1alpha1.HookVersionV1 // Default to v1 if not specified
}

func (w *webhookExecutor) GetVersion() v1alpha1.HookVersion {
