...
type ControllerRevisionLister interface {
	...
	List(selector labels.Selector) (ret []*metacontrollerv1alpha1.ControllerRevision, err error)
...
type controllerRevisionLister struct {
	listers.ResourceIndexer[*metacontrollerv1alpha1.ControllerRevision]
}
...
func NewControllerRevisionLister(indexer cache.Indexer) ControllerRevisionLister {
	return &controllerRevisionLister{listers.New[*metacontrollerv1alpha1.ControllerRevision](indexer, metacontrollerv1alpha1.Resource("controllerrevision"))}
}

// ControllerRevisions returns an object that can list and get ControllerRevisions.
func (s *controllerRevisionLister) ControllerRevisions(namespace string) ControllerRevisionNamespaceLister {
	return controllerRevisionNamespaceLister{listers.NewNamespaced[*metacontrollerv1alpha1.ControllerRevision](s.ResourceIndexer, namespace)}
}
...
type ControllerRevisionNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*metacontrollerv1alpha1.ControllerRevision, error)
