...
This page describes how Metacontroller applies changes to managed resources. Historically, Metacontroller has used a dynamic apply approach, which emulates [`kubectl apply`][kubectl apply], particularly for working with CRDs.
