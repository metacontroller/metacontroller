# [1.0.0](https://github.com/grzesuav/metacontroller/compare/v0.4.3...v1.0.0) (2021-07-13)


### Bug Fixes

* **composite controller:** [#68](https://github.com/grzesuav/metacontroller/issues/68) - Skip registration until parent resource ([71fd2df](https://github.com/grzesuav/metacontroller/commit/71fd2df5c5505750636b94a3c83459cb85970fda))
* **composite controller:** Fixed GroupVersion management ([c5f4c09](https://github.com/grzesuav/metacontroller/commit/c5f4c09a49f1c8192980e7c799d9d457c6dddb2c))
* **ControllerRevision:** [#144](https://github.com/grzesuav/metacontroller/issues/144) - Fix ControllerRevision management ([d405959](https://github.com/grzesuav/metacontroller/commit/d4059597ebc222ef01e4156b00b04536fa97ca64))
* **customize:** [#259](https://github.com/grzesuav/metacontroller/issues/259) - Add guard for customize cache against concurrent writes ([b765c17](https://github.com/grzesuav/metacontroller/commit/b765c1731dfe28917fd84aee35c3e8e175a3850f))
...
* **deps:** update alpine docker tag to v3.13.3 ([953ae99](https://github.com/grzesuav/metacontroller/commit/953ae99ed2e0e447025afc97c8500f7f271c8290))
* **deps:** update alpine docker tag to v3.13.4 ([c3901c9](https://github.com/grzesuav/metacontroller/commit/c3901c92d3d7dee61707a0777967690c5b0dae77))
* **deps:** update alpine docker tag to v3.13.5 ([bef407b](https://github.com/grzesuav/metacontroller/commit/bef407b441d572c0dfb78e7b5cc1da0882a25327))
* **deps:** update alpine docker tag to v3.14.0 ([a252fbb](https://github.com/grzesuav/metacontroller/commit/a252fbb271f6691373c21d4ce1aee3bb2f8c7894))
...
* **deps:** Update controllrt-runtime to 0.9.2 & k8s.io to v0.21.2 ([4031180](https://github.com/grzesuav/metacontroller/commit/4031180ed0c416b727da8c84efb3ee5b50b01dbd))
...
* **deps:** Update go-cmp v0.5.6 prometheus/client_golang v1.10.0 ([1748a91](https://github.com/grzesuav/metacontroller/commit/1748a9171b37dde7d527edc16b74cf0ba7f49cc5))
...
* **deps:** update golang docker tag to v1.16.2 ([53d66d4](https://github.com/grzesuav/metacontroller/commit/53d66d4aaff1818871346d244dece0a9876cf020))
* **deps:** update golang docker tag to v1.16.3 ([a5ab1fc](https://github.com/grzesuav/metacontroller/commit/a5ab1fcab058af2db3d203fe3afeb8371ceabc92))
* **deps:** update golang docker tag to v1.16.5 ([d6fca11](https://github.com/grzesuav/metacontroller/commit/d6fca11088663668dfe04b1a6bf8bcedf9f45cdb))
* **deps:** Update golang to 1.16.4 ([b7e8a33](https://github.com/grzesuav/metacontroller/commit/b7e8a33a376d38f02f924fc5e154b3a07130af1e))
* **deps:** Update golang.org/x/text dependency due to CVE-2020-14040 ([3e6ae6a](https://github.com/grzesuav/metacontroller/commit/3e6ae6a6bb83804f9efc25b59e2024a7e159ac09))
* **deps:** Update k8s and controller-runtime dependencies ([256f20e](https://github.com/grzesuav/metacontroller/commit/256f20e2c5c3e86fcacf882d781ed2881cbe6f95))
...
* **deps:** update k8s.io/utils commit hash to 6fdb442 ([f713086](https://github.com/grzesuav/metacontroller/commit/f713086f6c93f0873e3257e1bc035cb6f4900819))
* **deps:** Update klog/v2 to v2.9.0 ([47aa552](https://github.com/grzesuav/metacontroller/commit/47aa552f6648a016ca69edf7527404f006032224))
...
* **deps:** Update klog2 to v2.8.0 ([9cf1ecc](https://github.com/grzesuav/metacontroller/commit/9cf1ecc9b66636fcff74e8c4336341052620fa73))
* **deps:** update module github.com/prometheus/client_golang to v1.11.0 ([06ea53d](https://github.com/grzesuav/metacontroller/commit/06ea53db876f3888004c34beab1bacc19aa50cd3))
* **deps:** update module sigs.k8s.io/controller-runtime to v0.9.0 and k8s.io packages to v0.21.1 ([c07dcb3](https://github.com/grzesuav/metacontroller/commit/c07dcb3a50a7d1976dd85a294ec71b69843c4a24))
...
* **events:** Emit events for controller sync errors ([9b7258d](https://github.com/grzesuav/metacontroller/commit/9b7258d10fb72ab6e7f49d6cf9af4eaf8d538dc7))
* **metrics:** [#289](https://github.com/grzesuav/metacontroller/issues/289) - Wait on signal before exiting to fix http server with metrics ([f646a90](https://github.com/grzesuav/metacontroller/commit/f646a9078785aef40deda04db9e870805f89f026))
* **metrics:** Utilize controller-runtime  metrics server ([45b80c3](https://github.com/grzesuav/metacontroller/commit/45b80c35170863e7377a2960bb8dacac0893a186))
...
* **security:** Update golang.org/x/crypto because of CVE-2020-29652 ([38c0c2f](https://github.com/grzesuav/metacontroller/commit/38c0c2fdb7e24345a9fde27ad005cd095a6e29fc))
...
* [#170](https://github.com/grzesuav/metacontroller/issues/170) - Emit kubernetes events ([260acca](https://github.com/grzesuav/metacontroller/commit/260accaffe954c77614d14859ef4aba07c61bcc6))
...
* **k8sClient:** use a cache-based version of k8s client ([17f3dd2](https://github.com/grzesuav/metacontroller/commit/17f3dd259890f4942ba22347e3dbe6bd2c9eedd3))
