...
// This is copied from k8s.io/kubernetes/staging/src/k8s.io/client-go/util.
// TODO(enisoc): Remove this and use k8s.io/client-go/util/retry after it gets published.
